...
class cityscapes(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'cityscapes' + '_' + image_set)
        self._year = 2007
        self._image_set = image_set
        self._devkit_path = cfg_d.CAR
        self.result_path = '/home/rzj/data'
        self._data_path = os.path.join(self._devkit_path, 'cityscapes_od')
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self.result_path, 'results', 'cityscapes', 'Main')
    ...
    def _do_python_eval(self, output_dir='output'):
        ...
        imagesetfile = os.path.join(
            ...
            'Main',
            self._image_set + '.txt')
        cachedir = os.path.join(self.result_path, 'annotations_cache')
        aps = []
