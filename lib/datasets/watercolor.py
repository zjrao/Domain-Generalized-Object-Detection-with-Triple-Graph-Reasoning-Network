...
class watercolor(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'watercolor22' + '_' + image_set)
        self._image_set = image_set
        self._devkit_path = cfg_d.WATERCOLOR
        self._data_path = os.path.join(self._devkit_path, 'watercolor2021')
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._devkit_path, 'results', 'watercolor2021', 'Main')
