...
class sketch(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'sketch22' + '_' + image_set)
        self._image_set = image_set
        self._devkit_path = cfg_d.SKETCH
        self._data_path = os.path.join(self._devkit_path, 'sketch2021')
        ...
        assert os.path.exists(self._devkit_path), \
            'SKETCH path does not exist: {}'.format(self._devkit_path)
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._devkit_path, 'results', 'sketch2021', 'Main')
