...
class clipart(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'clipart22' + '_' + image_set)
        self._image_set = image_set
        self._devkit_path = cfg_d.CLIPART
        self._data_path = os.path.join(self._devkit_path, 'clipart2021')
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._devkit_path, 'results', 'clipart2021', 'Main')
